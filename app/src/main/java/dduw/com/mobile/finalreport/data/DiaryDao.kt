...
class DiaryDao {
    ...
    init {
        diaries.add( DiaryDto(1, "첫번째 기록", "2024/01/01", "맑음", "좋음", "첫번쩨 내용"))
        diaries.add( DiaryDto(2, "두번째 기록", "2024/02/01", "흐림", "슬픔", "두번쩨 내용"))
        diaries.add( DiaryDto(3, "세번째 기록", "2024/03/01", "비", "행복", "세번쩨 내용"))
        diaries.add( DiaryDto(4, "네번째 기록", "2024/04/01", "맑음", "신남", "네번쩨 내용"))
    }
